export type Sop = {
    ...
    "instructions": [
        ...
        },
        {
            ...
            "accounts": [
                ...
                {
                    "name": "parentProfileVaultPda";
                    "isMut": false;
                    "isSigner": false;
                },
                {
                    "name": "grandParentProfileVaultPda";
                    "isMut": false;
                    "isSigner": false;
                },
                {
                    "name": "greatGrandParentProfileVaultPda";
                    "isMut": false;
                    "isSigner": false;
                },
                {
                    "name": "ggreatGrandParentProfileVaultPda";
                    "isMut": false;
                    "isSigner": false;
                },
                {
                    "name": "genesisProfileVaultPda";
                    "isMut": false;
                    "isSigner": false;
                },
                {
    ...
    "errors": [
        ...
        {
            "code": 6011;
            "name": "AlreadyOneMinted";
            "msg": "Already one minted";
        }
    ];
};
export declare const IDL: Sop;
